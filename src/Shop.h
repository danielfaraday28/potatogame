...
public:
    ...
    void sellOwnedItem(int ownedIndex, Player& player);
...
private:
    ...
    int selectedOwnedItem;   // index of selected owned item in player's array (-1 if none)
    int hoveredOwnedItem;    // hover index for owned items
